...
; the same attribute, so init.s and CAPS share ria_caps_set.

.segment "CODE"

; ----------------------------------------------------------
; ria_caps_set — set RIA_ATTR_RLN_CAPS = X (mode 0/1/2).
...
; ria_caps_set; everything else raises ?ILLEGAL QUANTITY.
; ----------------------------------------------------------
CAPS:
